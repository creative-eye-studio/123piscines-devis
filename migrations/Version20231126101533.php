 ...
 */
final class Version20231126101533 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piscine_tailles ADD CONSTRAINT FK_7BA5460FFFDB5CFB FOREIGN KEY (filtrations_id) REFERENCES filtrations (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
