 ...
 */
final class Version20231116204234 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piscine_tailles ADD CONSTRAINT FK_7BA5460FBCE84E7C FOREIGN KEY (forme_id) REFERENCES piscine_forme (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
